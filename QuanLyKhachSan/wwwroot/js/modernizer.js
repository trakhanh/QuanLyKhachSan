				...
				window.Modernizr = function(a, b, c) {
				        ...
				        function y(a, b, d) { for (var e in a) { var f = b[a[e]]; if (f !== c) return d === !1 ? a[e] : w(f, "function") ? f.bind(d || b) : f } return !1 } var d = "2.8.3",
				            ...
				            function(a, b) {
				                ...
				                a.html5 = s, r(b) }(this, b), e._version = d, g.className = g.className.replace(/(^|\n)no-js(\n|$)/, "$1$2") + (f ? " js " + p.join(" ") : ""), e }(this, this.document),
				    function(a, b, c) {
				...
				(function(global, factory) {
				    ...
				    var matchWord = /[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\n*?[\u0600-\u06FF]{1,256}){1,2}/i;
				    ...
				    var extendedIsoRegex = /^\n*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\n*Z)?)?$/;
				    var basicIsoRegex = /^\n*((?:[+-]\d{6}|\d{4})(?:\d\d\d\d|W\d\d\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?:\d\d(?:\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\n*Z)?)?$/;
				    ...
				    var rfc2822 = /^(?:(Mon|Tue|Wed|Thu|Fri|Sat|Sun),?\n)?(\d{1,2})\n(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\n(\d{2,4})\n(\d\d):(\d\d)(?::(\d\d))?\n(?:(UT|GMT|[ECMP][SD]T)|([Zz])|([+-]\d{4}))$/;
